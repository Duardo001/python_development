...
#difference_update(), intersection_update() e symetric_difference_update()
...
#métodos .difference(), .symetric_difference(), .union(), .intersection()
'''conjunto1 = {"Mega Drive", "Super Nintendo", "Playstation"}
conjunto2 = {"Playstation", "Nintendo 64", "Sega Saturn", "Dreamcast"}
